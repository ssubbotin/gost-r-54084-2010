...
Данные извлечены из PDF методом OCR-парсинга текстового слоя и прошли три раунда верификации:
...
Все обнаруженные ошибки парсинга исправлены. Оставшиеся аномалии — ошибки оригинального печатного издания стандарта, подтверждённые сверкой с PDF. Полный перечень — в [`ERRORS.md`](ERRORS.md).

~50 кортежей содержат `(None, None)` — значения отсутствуют в текстовом слое PDF (преимущественно h=3000).
